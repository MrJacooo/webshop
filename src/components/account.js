        ...
        <Paper sx={{ padding: "10px", marginBottom: "20px" }}>
            <Grid container>
                <Grid item xs={12} md={4}>
                    ...
                    <p>{props.reservation.additions.bedsheets ? "Bedsheets have been Booked" : "No extra Bedsheets"}</p>
                ...
                <Grid item xs={12} md={8}>
                    <div style={{ width: "100%" }}>
                        <iframe
                            ...
                            src={"https://www.google.com/maps/embed/v1/place?key=AIzaSyBua4pf7BAFAqhfLHJsqIzWh2T3GpoOGq4&q=" + props.reservation.house.location + "&zoom=8"} />
                    </div>
                </Grid>
            </Grid>
        </Paper>
